  ...
  <div>
    ...
    <section class="py-12">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div class="glass rounded-2xl p-6 text-center border border-slate-700/50">
          ...
          <p class="text-slate-400 mt-1">{{ $t('home.activeLotteries') }}</p>
        </div>
        <div class="glass rounded-2xl p-6 text-center border border-slate-700/50">
          <p class="text-3xl font-bold text-purple-400">€89,500</p>
          <p class="text-slate-400 mt-1">{{ $t('home.prizesWon') }}</p>
        </div>
        <div class="glass rounded-2xl p-6 text-center border border-slate-700/50">
          <p class="text-3xl font-bold text-pink-400">5,678</p>
          <p class="text-slate-400 mt-1">{{ $t('home.happyWinners') }}</p>
        </div>
        <div class="glass rounded-2xl p-6 text-center border border-slate-700/50">
          <p class="text-3xl font-bold text-emerald-400">€12,300</p>
          <p class="text-slate-400 mt-1">{{ $t('home.donatedToCharity') }}</p>
        </div>
      </div>
    </section>
    ...
    <section class="py-12">
      ...
      <div v-else-if="popularLotteries.length === 0" class="text-center py-12 glass rounded-2xl border border-slate-700/50">
        ...
        <p class="text-slate-400 text-lg">{{ $t('home.noLotteriesYet') }}</p>
    ...
    <section class="py-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="text-center">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">{{ $t('home.step1Title') }}</h3>
          <p class="text-slate-400">{{ $t('home.step1Desc') }}</p>
        </div>
        <div class="text-center">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">{{ $t('home.step2Title') }}</h3>
          <p class="text-slate-400">{{ $t('home.step2Desc') }}</p>
        </div>
        <div class="text-center">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">{{ $t('home.step3Title') }}</h3>
          <p class="text-slate-400">{{ $t('home.step3Desc') }}</p>
        </div>
      </div>
    </section>
